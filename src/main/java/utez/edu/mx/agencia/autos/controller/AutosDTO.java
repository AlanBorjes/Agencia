...
public class AutosDTO {
    ...
    public AutosDTO(long id, String name, String matricula, String yearVerification, String dateCreacion, String dateUpdate, int status, Marca marca) {
        this.id = id;
        this.name = name;
    ...
    public AutosDTO(String name, String matricula, String yearVerification, String dateCreacion, String dateUpdate, int status, Marca marca) {
        this.name = name;
        this.matricula = matricula;
        this.yearVerification = yearVerification;
        this.dateCreacion = dateCreacion;
